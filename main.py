from config import user_token, bot_token, offset, line
import vk_api
import requests
import datetime
...
class Bot:
        ...
        try:
            ...
            for person_dict in list_1:
                if person_dict.get('is_closed') == False:
                    ...
                    id_vk = str(person_dict.get('id'))
                    link_vk = 'vk.com/id' + str(person_dict.get('id'))
                    insert_data_users(first_name, last_name, id_vk, link_vk)
                else:
                    continue
    ...
    def find_persons(self, user_id, offset):
        ...
        insert_data_viewed_users(self.person_id(offset), offset) #offset
